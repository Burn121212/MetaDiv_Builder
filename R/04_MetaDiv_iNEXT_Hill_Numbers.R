# =============================================================================
# 04_MetaDiv_iNEXT_Hill_Numbers.R
# =============================================================================
# MetaDiv Explorer
#
...
FOR_R_DIR <- "C:/Users/berna/Desktop/META DIV BUILDER V1.6/output/ITS/For_R/all_eukaryotes/species_only_p1_sppn08"
...
capture.output(
  sessionInfo(),
  file = file.path(INEXT_DIR, "R_sessionInfo_script04_iNEXT.txt")
)
